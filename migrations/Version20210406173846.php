 ...
 */
final class Version20210406173846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rate (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(64) NOT NULL, amount DOUBLE PRECISION NOT NULL, text LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
